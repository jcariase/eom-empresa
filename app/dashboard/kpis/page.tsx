...
// El tipo 'dso' (A÷B)×30 se mantiene en el motor de cálculo porque hay una
// empresa con un KPI instalado que lo usa (no se toca), pero ya no se ofrece
// en la biblioteca -- "Días de cobranza (DSO)" se reemplazó por un ratio simple.
...
const BIBLIOTECA: Record<string, BibliotecaKPI[]> = {
  ...
  'Operaciones': [
    ...
    kpiRatio('Tasa de retrabajo', 'porcentaje', 5, true, 'Trabajos con retrabajo en el mes', 'Total de trabajos del mes', 'Qué fracción del trabajo hubo que rehacer. Se cuenta, no se estima.'),
  ],
  'Administración y Finanzas': [
    ...
    kpiRatio('Facturas vencidas sin cobrar', 'porcentaje', 10, true, 'Facturas vencidas impagas', 'Total facturas por cobrar', 'De todas las facturas por cobrar, cuántas ya vencieron. Se cuenta de la carpeta de cobranza.'),
    kpiDirecto('Gastos fijos del mes', 'pesos', 0, true, 'El mismo número que reportas en tu medición mensual. La referencia es tu baseline.'),
    kpiDirecto('Saldo de caja disponible', 'pesos', 0, false, 'Banco más efectivo, hoy. Un vistazo a la cuenta.'),
  ...
  'Logística y Bodega': [
    kpiRatio('Exactitud de inventario', 'porcentaje', 98, false, 'Ítems correctos de la muestra', 'Ítems contados en la muestra', 'Cuenta una muestra de 20 ítems al mes y compara contra el registro.'),
    ...
    kpiDirecto('Ítems sin movimiento hace 90 días', 'numero', 0, true, 'Productos que no se venden hace 3 meses. Se cuentan caminando por la bodega.'),
  ...
  'Servicio Técnico': [
    ...
    kpiDirecto('Reclamos de garantía del mes', 'numero', 0, true, 'Cuántas veces volvió un trabajo dentro de garantía.'),
  ],
}
