  ...
  return (
    <>
      ...
      <div className="card">
        ...
        <div className="badge">Cuenta pendiente</div>
        <div className="title">Tu cuenta está lista para activarse</div>
        <p className="body">
          Tu cuenta y tu onboarding quedaron guardados. Para activar la plataforma, coordinemos una llamada de inicio donde definimos los próximos pasos.
        </p>
        <div className="actions">
          <a className="btn" href={`mailto:${CONTACT_EMAIL}`}>Agendar llamada →</a>
